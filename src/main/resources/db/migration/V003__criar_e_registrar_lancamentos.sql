...
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo, codigo_categoria, codigo_pessoa) 
            VALUES ('Salário mensal', '2023-12-05', NULL, 6720, 'Salário líquido', 'RECEITA', 1, 1);
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo, codigo_categoria, codigo_pessoa)
            VALUES ('Trabalho de Pintura', '2023-12-10', NULL, 1500, 'Serviço de pintura na casa do vizinho', 'RECEITA', 2, 2);
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo, codigo_categoria, codigo_pessoa) 
...
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo, codigo_categoria, codigo_pessoa) 
            VALUES ('Alimentação do Refeitório', '2023-12-10', NULL, 125, 'Valor dos Tickets cobrados pelo refeitório', 'DESPESA', 3, 4);
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo, codigo_categoria, codigo_pessoa) 
...
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo, codigo_categoria, codigo_pessoa) 
            VALUES ('Valor da Luz', '2023-12-03', NULL, 150, 'Valor da Luz relativo ao mês de Novembro/2023', 'DESPESA', 6, 9);